#!/usr/bin/env python3
"""
Interactive Browser LangGraph CUA Example
This example lets you input your own browser automation requests and watch them execute in real-time!
"""
...
class InteractiveBrowserState(BaseModel):
    """State for the interactive browser CUA."""
...
def plan_task(state: InteractiveBrowserState) -> Dict[str, Any]:
...
async def execute_browser_task(state: InteractiveBrowserState) -> Dict[str, Any]:
    ...
    try:
        ...
        if not state.browser:
            ...
            state.browser = await playwright.chromium.launch(headless=False)
...
def generate_response(state: InteractiveBrowserState) -> Dict[str, Any]:
...
async def cleanup_browser(state: InteractiveBrowserState) -> Dict[str, Any]:
...
workflow = StateGraph(InteractiveBrowserState)
...
async def main():
    """Run the interactive browser CUA."""
    print("🚀 Interactive Browser LangGraph CUA")
    print("=" * 50)
    print("This will open a real browser window and perform automation based on your requests!")
    print("=" * 50)
    ...
    print("- Navigate to Google and show me the page")
    ...
    while True:
        ...
        initial_state = InteractiveBrowserState(
